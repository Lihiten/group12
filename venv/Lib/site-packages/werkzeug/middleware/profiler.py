...
class ProfilerMiddleware:
    """Wrap a WSGI application and workshop-details the execution of each
    ...
    :param profile_dir: Save workshop-details data files to this directory.
    :param filename_format: Format string for workshop-details data file names,
