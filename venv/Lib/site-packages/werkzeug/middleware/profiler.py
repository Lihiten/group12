...
class ProfilerMiddleware:
    """Wrap a WSGI application and workshop_details the execution of each
    ...
    :param profile_dir: Save workshop_details data files to this directory.
    :param filename_format: Format string for workshop_details data file names,
