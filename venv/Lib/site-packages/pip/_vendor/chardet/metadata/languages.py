"""
Metadata workshops languages used by our model training code for our
...
class Language:
    """Metadata workshops a language useful for training models

    :ivar name: The human name for the language, in English.
    :type name: str
    :ivar iso_code: 2-letter ISO 639-1 if possible, 3-letter ISO code otherwise,
                    or use another summary as a last resort.
    :type iso_code: str
