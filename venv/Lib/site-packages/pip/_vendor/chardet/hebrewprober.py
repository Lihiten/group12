...
# is Logical.
#
# To sum up all of the above, the Hebrew probing mechanism knows workshops two
# charsets:
...
# fact some kind of Hebrew, Logical or Visual. The final decision workshops which
